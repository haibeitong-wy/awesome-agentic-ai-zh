...
> 上面只是 highlight。**完整 54 个集成***的分类***目录**（含***数据***库、浏览器***自动***化、Figma、Excalidraw、Cloudflare、Stripe、***学术******写作*** / Multi-LLM delegation 等）在 [`resources/mcp-skills-catalog.zh-CN.md`](resources/mcp-skills-catalog.zh-CN.md)。
